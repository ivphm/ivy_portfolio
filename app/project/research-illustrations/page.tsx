...
export default function ResearchIllustrationsPage() {
  return (
    <ProjectPageLayout title={p.title} subtitle={p.subtitle} meta={p.meta}>
      <p style={{ fontSize: '16px', lineHeight: 1.6, whiteSpace: 'pre-line' }}>{`This project features a collaboration with SUTD professors and researchers in illustrating various complex scientific concepts in an easily digestible format.

*Note this project is ongoing.`}</p>

      <div>
        <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '12px' }}>Ballistic Electrons in Graphene:</h2>
      ...
      <div>
        <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '16px' }}>Other Quantum-Nano Photonic Illustrations:</h2>
      ...
      <div>
        <h2 style={{ fontSize: '20px', fontWeight: 700, marginBottom: '16px' }}>Logo Design for W.Labs</h2>
